...
jsonApi.define({
  ...
  attributes: {
    ...
    created: jsonApi.Joi.string()
      .regex(/^[12]\d\d\d-[01]\d-[0123]\d$/)
    ...
    status: jsonApi.Joi.string()
      ...
      .example('published'),
    views: jsonApi.Joi.number()
      .default(0)
      .description('Number of views for this article'),
    author: jsonApi.Joi.one('people').description(
  ...
  examples: [
    {
      ...
      tags: [{ type: 'tags', id: '7541a4de-4986-4597-81b9-cf31b6762486' }],
      photos: [],
      comments: [
    ...
    },
    {
      ...
      tags: [{ type: 'tags', id: '2a3bdea4-a889-480d-b886-104498c86f69' }],
      photos: [
    ...
    },
    {
      ...
      tags: [{ type: 'tags', id: '8d196606-134c-4504-a93a-0d372f78d6c5' }],
      photos: [{ type: 'photos', id: 'aab14844-97e7-401c-98c8-0bd5ec922d93' }],
      comments: [],
    },
    {
      ...
      photos: [{ type: 'photos', id: '4a8acd65-78bb-4020-b9eb-2d058a86a2a0' }],
      comments: [
