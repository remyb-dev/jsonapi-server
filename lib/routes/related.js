      ...
      async.waterfall(
        [
          ...
          callback => {
            ...
            if (
              !relation ||
              !relation._flags._settings ||
              !(relation._flags._settings.__one || relation._flags._settings.__many)
            ) {
              return callback({
            ...
            if (relation._flags._settings.__as) {
              return callback({
                // eslint-disable-line standard/no-callback-literal
                status: '404',
                code: 'EFOREIGN',
          ...
          (newResources, callback) => {
            ...
            if (relation._flags._settings.__one) {
