...
swagger._getSwaggerBase = () => {
  ...
  if (jsonApi._apiConfig.urlPrefixAlias) {
    ...
    basePath = jsonApi._apiConfig.base.substring(
      0,
      jsonApi._apiConfig.base.length - 1
    )
  ...
  return {
    ...
    parameters: {
      ...
      include: {
        ...
        in: 'query',
        description:
          'Fetch additional resources as per the JSON:API specification',
        required: false,
        type: 'string',
      },
      filter: {
      ...
      fields: {
        ...
        in: 'query',
        description:
          'Limit response payloads as per the JSON:API specification',
        required: false,
        type: 'string',
      },
      page: {
