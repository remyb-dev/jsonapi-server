...
jsonApiGraphQL.generate = allResourceConfig => {
  ...
  const readSchema = jsonApiGraphQL.generateReadSchema(
    allReadTypes,
    allResourceConfig
  )

  const allWriteTypes = writeTypes.generate(allResourceConfig, allReadTypes)
  const writeSchema = jsonApiGraphQL.generateWriteSchema(
    allReadTypes,
    allResourceConfig,
    allWriteTypes
  )
...
jsonApiGraphQL.generateWriteSchema = (
  allReadTypes,
  allResourceConfig,
  allWriteTypes
) => {
